...
/* harmony import */ var _utils_5174e079_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils-5174e079.js */ "./node_modules/@ionic-super-tabs/core/dist/esm/utils-5174e079.js");
...
const SuperTabButtonComponent = class {
    ...
    render() {
        return (Object(_core_4ed83284_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_core_4ed83284_js__WEBPACK_IMPORTED_MODULE_0__["H"], { role: "button", "aria-label": this.label ? this.label.innerText : false, "aria-disabled": this.disabled ? 'true' : false, "aria-selected": this.active ? 'true' : 'false', class: {
            ...
            } }, Object(_core_4ed83284_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", null), Object(_core_4ed83284_js__WEBPACK_IMPORTED_MODULE_0__["h"])("ion-ripple-effect", { type: "unbounded" })));
    }
    get el() { return Object(_core_4ed83284_js__WEBPACK_IMPORTED_MODULE_0__["g"])(this); }
...
const SuperTabsToolbarComponent = class {
    constructor(hostRef) {
        ...
        this.hostCls = {};
        this.clientWidth = 0;
        this.buttonClick = Object(_core_4ed83284_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "buttonClick", 7);
    }
    ...
    moveContainer(scrollX, animate) {
        ...
        Object(_utils_5174e079_js__WEBPACK_IMPORTED_MODULE_1__["s"])(this.buttonsContainerEl, scrollX, 0, animate ? this.config.transitionDuration : 0);
        return Promise.resolve();
    }
    onClick(ev) {
        if (!ev || !ev.target) {
    ...
    async onTouchMove(ev) {
        ...
        // scroll container
        const scrollLeft = Object(_utils_5174e079_js__WEBPACK_IMPORTED_MODULE_1__["g"])(this.buttonsContainerEl);
        const scrollX = Object(_utils_5174e079_js__WEBPACK_IMPORTED_MODULE_1__["a"])(this.buttonsContainerEl, deltaX);
    ...
    adjustContainerScroll(animate) {
        ...
        const sp = Object(_utils_5174e079_js__WEBPACK_IMPORTED_MODULE_1__["g"])(this.buttonsContainerEl);
     ...
     */
    debug(...vals) {
        Object(_utils_5174e079_js__WEBPACK_IMPORTED_MODULE_1__["d"])(this.config, 'toolbar', vals);
    }
    render() {
        return (Object(_core_4ed83284_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_core_4ed83284_js__WEBPACK_IMPORTED_MODULE_0__["H"], { role: "navigation", class: this.hostCls }, Object(_core_4ed83284_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "buttons-container", ref: (ref) => this.buttonsContainerEl = ref }, Object(_core_4ed83284_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", null), this.showIndicator &&
            Object(_core_4ed83284_js__WEBPACK_IMPORTED_MODULE_0__["h"])("super-tab-indicator", { ref: (ref) => this.indicatorEl = ref, toolbarPosition: this.el.assignedSlot.name }))));
    }
    get el() { return Object(_core_4ed83284_js__WEBPACK_IMPORTED_MODULE_0__["g"])(this); }
